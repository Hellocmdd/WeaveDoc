...
| 右侧辅助栏 | `Views/AiAssistantPanel.*`、`Views/RagChatView.*`、`Views/LiteratureView.*`、`Views/RagCorpusView.*`、`Views/RagSnapshotView.*` | 问答、BibTeX 文献库（导入 .bib、插入 [@key] 引用）、RAG 语料管理、检索快照展示 |
