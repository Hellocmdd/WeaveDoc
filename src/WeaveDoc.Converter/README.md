...
dotnet test tests/WeaveDoc.Converter.Tests/                     # 82 测试
```
...
| `AfdStyleMapperTests` | 4 | 双向映射（14 个 AFD 键 + 异常/空值） |
| `BibtexParserTests` | 10 | BibTeX 解析全场景 |
| `ConfigManagerTests` | 8 | 模板 CRUD + 种子发现 |
| `PandocPipelineTests` | 23 | 管道转换、公式预处理、错误信息格式化、样式修正、页眉页脚、3 模板端到端 |
